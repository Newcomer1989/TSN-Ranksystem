							...
							<div class="panel panel-green">
								<div class="panel-heading">
									<div class="row">
										...
										<div class="col-xs-9 text-right">
											<div class="huge"><?php if (round(($sql_res['total_online_time'] / 86400)) == 1) {
											    echo sprintf($lang['day'], round(($sql_res['total_online_time'] / 86400)));
											} else {
											    echo sprintf($lang['days'], round(($sql_res['total_online_time'] / 86400)));
											} ?></div>
							...
							<div class="panel panel-yellow">
								<div class="panel-heading">
									<div class="row">
										...
										<div class="col-xs-9 text-right">
											<div class="huge"><?php if (round(($sql_res['total_online_month'] / 86400)) == 1) {
											    echo sprintf($lang['day'], round(($sql_res['total_online_month'] / 86400)));
											} else {
											    echo sprintf($lang['days'], round(($sql_res['total_online_month'] / 86400)));
											} ?></div>
											<div><?php if ($sql_res['total_online_month'] == 0) {
											    echo $lang['stix0048'];
											} else {
											    echo $lang['stix0049'];
											} ?></div>
							...
							<div class="panel panel-red">
								<div class="panel-heading">
									<div class="row">
										...
										<div class="col-xs-9 text-right">
											<div class="huge"><?php if (round(($sql_res['total_online_week'] / 86400)) == 1) {
											    echo sprintf($lang['day'], round(($sql_res['total_online_week'] / 86400)));
											} else {
											    echo sprintf($lang['days'], round(($sql_res['total_online_week'] / 86400)));
											} ?></div>
											<div><?php if ($sql_res['total_online_week'] == 0) {
											    echo $lang['stix0048'];
											} else {
											    echo $lang['stix0050'];
											} ?></div>
								...
								<table class="table table-bordered table-hover" id="ts-server-details-left">
									<tbody>
										<tr>
											...
											<td><?php if ($sql_res['server_status'] == 1 || $sql_res['server_status'] == 3) {
											    echo '<span class="text-success">'.$lang['stix0024'].'</span>';
											} else {
											    echo '<span class="text-danger">'.$lang['stix0025'].'</span>';
											} ?></td>
										</tr>
										<tr>
											<td><?php echo $lang['stix0026']; ?></td>
											<td><?php if ($sql_res['server_status'] == 0) {
											    echo '0';
											} else {
											    echo $sql_res['server_used_slots'] , ' / ' ,($sql_res['server_used_slots'] + $sql_res['server_free_slots']);
											} ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><?php if ($sql_res['server_status'] == 0) {
											    ...
											    echo $sql_res['server_ping'].' '.$lang['time_ms'];
											} ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><?php $serveruptime = new DateTime('@'.$sql_res['server_uptime']);
    if ($sql_res['server_status'] == 0) {
        echo '-&nbsp;&nbsp;&nbsp;(<i>'.$lang['stix0032'].'<span class="item-margin">'.(new DateTime('@0'))->diff($serveruptime)->format($cfg['default_date_format']).')</span></i>';
    } else {
        echo $lang['stix0033'];
    } ?></td>
										</tr>
										<tr>
											...
											<td><?php if ($sql_res['server_status'] == 0) {
											    ...
											    echo $sql_res['server_packet_loss'] * 100 ,' %';
											} ?></td>
										</tr>
									</tbody>
								</table>
								...
								<table class="table table-bordered table-hover" id="ts-server-details-right">
									<tbody>
										...
										<tr>
											...
											<td><?php if ($sql_res['server_pass'] == '0') {
											    echo $lang['stix0039'];
											} else {
											    echo $lang['stix0040'];
											} ?></td>
										...
										<tr>
											...
											<td><?php if ($sql_res['server_creation_date'] == 0) {
											    echo $lang['stix0051'];
											} else {
											    echo date('d/m/Y', $sql_res['server_creation_date']);
											} ?></td>
										</tr>
										<tr>
											<td><?php echo $lang['stix0045']; ?></td>
											<td><?php if ($sql_res['server_weblist'] == 1) {
											    echo $lang['stix0046'];
											} else {
											    echo $lang['stix0047'];
											} ?></td>
