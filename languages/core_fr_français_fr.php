...
$lang['isntwicfg']			= "Impossible d'enregistrer la configuration de la base de données ! Veuillez modifier le fichier '".DB_CONFIG."' avec un chmod 740 (dans la fênetre 'accès complet') et essayez de nouveau après.";
...
$lang['widbcfgerr']			= "Erreur lors de l'enregistrement des configurations de base de données ! Échec de la connexion ou erreur d'écriture pour le fichier '".DB_CONFIG."'";
