...
$lang['wiconferr']			= "Wystąpił błąd w konfiguracji systemu Ranksystem. Przejdz do interfejsu sięciowego i popraw ustawienia podstawowe. Szczegolnie sprawdz konfiguracje 'rank up'!";
...
$lang['wihladmrs15']		= "PProszę wybrać co najmniej jedną opcję!";
...
$lang['winav10']			= "Uzyj interfejsu sięciowego tylko przez %s HTTPS%s Szyfrowanie ma kluczowe znaczenie dla zapewnienia prywatnosci i bezpieczenstwa.%sAby moc korzystac z HTTPS, twoj serwer internetowy musi obsługiwac połączenie SSL";
...
$lang['wirtpw1']			= "Przepraszam, Bro, zapomniałes wczesniej wpisac swoj Bot-Admin w interfejsię internetowym. Nie ma sposobu na zresetowanie hasła!";
...
$lang['wishcolnx']			= "nastepna Pokażranga";
...
$lang['wisupidledesc']		= "Istnieją dwa tryby, poniewaz czas moze byc policzony, a nastepnie mozna ubiegac się o podwyzszenie rangi.<br><br>1) <b>czas online</b>: bierze się pod uwage czysty czas online użytkownika (see column 'sum. online time' in the 'stats/list_rankup.php')<br><br>2) <b>czas aktywny</b>: zostanie odjety od czasu online użytkownika, nieaktywny czas (bezczynnosc) (patrz kolumna 'suma aktywnego czasu' w 'stats / list_rankup.php').<br><br>Zmiana trybu z juz działającą bazą danych nie jest zalecana, ale moze działac.";
