...
$lang['insterr1']			= "UWAGA: Probujesz zainstalować Ranksystem, ale istnieje już baza danych o nazwie \"%s\".<br>Wymagana instalacja tej bazy danych zostanie usunieta!<br>Upewnij sie, ze tego chcesz. Jesli nie, wybierz inną nazwe bazy danych.";
...
$lang['wibot1']				= "Bot Ranksystem powinien zostać zatrzymany. Sprawdz ponizszy dziennik, aby uzyskac wiecej informacji!";
$lang['wibot2']				= "Bot Ranksystem powinien zostać uruchomiony. Sprawdz ponizszy dziennik, aby uzyskac wiecej informacji!";
$lang['wibot3']				= "Bot Ranksystem powinien zostać uruchomiony ponownie. Sprawdz ponizszy dziennik, aby uzyskac wiecej informacji!";
...
$lang['wimsgusrdesc']		= "Poinformuj uzytkownika o prywatnej wiadomości tekstowej o jego randze.";
...
$lang['wirtpw5']			= "Do administratora wysłano prywatną wiadomość tekstową TeamSpeak 3 z nowym hasłem. Kliknij %s tutaj %s aby sie zalogowac.";
...
$lang['wits3querusrdesc']	= "Nazwa uzytkownika zapytania TeamSpeak 3<br>Domyślna wartość to serveradmin<br>Oczywiście, możesz także utworzyć dodatkowe konto serwerowe tylko dla systemu Ranksystem.<br>Potrzebne uprawnienia, które można znaleźć:<br>%s";
...
$lang['wits3voicedesc']		= "Port głosowy TeamSpeak 3<br>Domyślna wartość to 9987 (UDP)<br>To jest port, ktorego używasz rownież do łączenia sie z klientem TS3.";
$lang['witsz']				= "Log-Size";
