...
$lang['winxinfodesc']		= "Разрешает отправлять RankSytem-боту команду \"!nextup\" личным сообщением.<br><br>После отправки команды пользователю будет отправлено ответное сообщение с информацией о требуемом времени до следующего повышения.<br><br><b>отключена</b> - Функция полностью отключена. Команда '!nextup' будет игнорироваться.<br><b>Включена - только следующий ранг</b> - Будет возвращаться время, необходимое для получения СЛЕДУЮЩЕГО ранга в системе рангов.<br><b>Включена - все следующие ранги</b> - Будет возвращаться время, необходимое для получения ВСЕХ последующих рангов в системе рангов.";
