...
$lang['sgrpadd']			= "Выдана группа сервера №%s пользователю %s (UID клиента: %s; DBID: %s).";
$lang['sgrprerr']			= "Что-то пошло не так! Проблема с группой сервера %s у пользователя (UID клиента: %s; ID в базе данных %s)!";
$lang['sgrprm']				= "С пользователя %s (UID: %s; DBID: %s) снята группа сервера %s.";
...
$lang['milliseconds']		= "мс"; //Average ping value - milliseconds on russian. Currently missing in the lang file.
//begin of $size = array(' B',' KiB',' MiB',' GiB',' TiB',' PiB',' EiB',' ZiB',' YiB');
$lang['B_russian']			= "Б";
$lang['KiB_russian']			= "КБ";
$lang['MiB_russian']			= "МБ";
$lang['GiB_russian']			= "ГБ";
...
$lang['stix0060']			= "Клиентов"; //there should be Пользователей, but it does not fit on 1366x768
...
$lang['winxmsgdesc2']		= "Данный текст будет отправлен пользователю при вводе команды \"nextup\", если пользователь уже достиг высшего ранга<br><br>Аргументы:<br>%1&#36;s - Оставшиеся дни до повышения<br>%2&#36;s - часы<br>%3&#36;s - минуты<br>%4&#36;s - секунды<br><br>Пример:<br>Вы получили максимальный ранг за %1&#36;s дней, %2&#36;s часов %3&#36;s минут и %4&#36;s секунд онлайна.";
