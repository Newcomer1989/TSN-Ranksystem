...
$lang['isntwicfg']			= "Não é possível salvar a configuração do banco de dados! Edite o '".DB_CONFIG."' com um chmod 740 (no windows 'acesso total') e tente novamente após.";
...
$lang['widbcfgerr']			= "Erro ao salvar as configurações do banco de dados! A conexão falhou ou escreveu erro para '".DB_CONFIG."'";
