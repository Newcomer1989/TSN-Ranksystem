...
$lang['cleancdesc']			= "Dzieki tej funkcji stare klienty z Systemu Rankow zostają usuniete. W tym celu system Ranksystem został zsynchronizowany z bazą danych TeamSpeak. Klienci, ktorych nie ma w TeamSpeak, zostaną usunieci z Systemu Rank. <br> <br> Ta funkcja jest aktywna tylko wtedy, gdy 'Query-Slowmode' jest nieaktywny! <br> <br> Do automatycznej regulacji TeamSpeak baza danych moze byc uzywana.<br><br><br>For automatic adjustment of the TeamSpeak database the ClientCleaner can be used:<br>//ts-n.net/clientcleaner.php";
