...
$lang['addonchdesc2desc']	= "<b>Erweiterte Optionen</b><br><br>Es ist auch möglich, eine <b>Wenn-Bedingung</b> festzulegen, welche nur dann einen bestimmten Text anzeigt, wenn die Bedingung erfüllt ist.<br><br>Beispiel:<br><pre>{if {&dollar;CLIENT_ONLINE_STATUS_1} === 'Online'}<br>    [COLOR=GREEN](Online)[/COLOR]<br>{else}<br>    [COLOR=RED](Offline)[/COLOR]<br>{/if}</pre><br><br>Sie können auch das <b>Datumsformat</b> ändern, indem Sie eine Formatdefinition am Ende einer Variablen setzen.<br><br>Beispiel:<br><pre>{&dollar;CLIENT_LAST_SEEN_1|date_format:&#34;&#37;d.&#37;m.&#37;Y &#37;H:&#37;M:&#37;S&#34;}</pre><br><br><b>Großbuchstaben</b> für einen Text.<br><br>Beispiel:<br><pre>{&dollar;CLIENT_NICKNAME_1|upper}</pre><br><br>Es ist auch möglich, Werte durch komplexe <b>reguläre Ausdrücke</b> zuersetzen.<br><br>Beispiel:<br><pre>{&dollar;CLIENT_VERSION_1|regex_replace:&#34;/(.*)(\[.*)/&#34;:&#34;&dollar;1&#34;}</pre><br><br>Alle Möglichkeiten, einen Variablenwert zu ändern, sind hier dokumentiert: %s<br>Alle möglichen Funktionen sind hier dokumentiert: %s";
