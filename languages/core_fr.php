...
$lang['wiselclddesc']		= "Sélectionnez les clients par leur dernier nom d'utilisateur connu, leur identifiant unique ou leur ID dans la base de données.<br>Des sélections multiples sont également possibles.<br><br>Sur les bases de données plus importantes, cette sélection pourrait être beaucoup plus lente.Il est recommandé de copier et coller le pseudonyme complet au lieu de le taper lettre par lettre.";
