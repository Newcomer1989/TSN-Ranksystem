...
$lang['isntwicfg']			= "Не получилось записать настройки базы данных! Пожалуйста, установите права на запись 'configs/dbconfig.php' chmod 740 (В windows 'Полный доступ') и попробуйте заново.";
...
$lang['widbcfgerr']			= "Ошибка сохранения настроек в базе данных! Ошибка подключения, проверьте на правильность настройки '/configs/dbconfig.php'";
