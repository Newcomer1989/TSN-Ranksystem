...
$lang['insterr2']			= "Для работы системы рангов требуется наличие модуля %1\$s. Пожалуйста, установите <a href=\"%2\$s\" target=\"_blank\">%1\$s</a> модуль и попробуйте заново!";
$lang['insterr3']			= "Для работы системы рангов требуется наличие включеной функции PHP %1\$s. Пожалуйста, включите данную <a href=\"%2\$s\" target=\"_blank\">%1\$s</a> функцию и попробуйте заново!";
