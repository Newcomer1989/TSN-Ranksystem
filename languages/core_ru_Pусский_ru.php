...
$lang['isntwicfg']			= "Не получилось записать настройки базы данных! Пожалуйста, установите права на запись '".DB_CONFIG."' chmod 740 (В windows 'Полный доступ') и попробуйте заново.";
...
$lang['widbcfgerr']			= "Ошибка сохранения настроек в базе данных! Ошибка подключения, проверьте на правильность настройки '".DB_CONFIG."'";
