...
if ($language == "de") {
    ...
    $lang['cleants']          = "Clients found in the TeamSpeak database: %s (at %s)";
	...
	$lang['isntwicfg']        = "Пожалуйста установите права на запись 'other/dbconfig.php' and the folder 'icons/' chmod 0777 и попробуйте снова.";
	...
	$lang['isntwidbhostdesc'] = "база данных server address<br>(IP or DNS)";
    $lang['isntwidbmsg']      = "Данных Ошибка: ";
    $lang['isntwidbname']     = "Имя Базы Данных:";
	$lang['isntwidbnamedesc'] = "Name of база данных";
    $lang['isntwidbpass']     = "Пароль Базы Данных:";
	$lang['isntwidbpassdesc'] = "Password to access the база данных";
	$lang['isntwidbtype']     = "база данных тип:";
	$lang['isntwidbtypedesc'] = "база данных тип<br><br>You have to install the needed PDO Driver.<br>For more informations look at requirements on http://ts-n.net/ranksystem.php";
    $lang['isntwidbusr']      = "Пользователь Базы Данных:";
	$lang['isntwidbusrdesc']  = "User to access the база данных";
    ...
    $lang['isntwicfg']        = "Please edit the 'other/dbconfig.php' and the folder 'icons/' with a chmod 0777 and try again after.";
