									...
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-8">
												...
												<?php
                                                echo '<option data-icon="fas fa-microphone-slash fa-fw" value="0"';
    if ($cfg['rankup_time_assess_mode'] == '0') {
        echo ' selected=selected';
    } echo '><span class="item-margin">',$lang['wishcolot'],'</span></option>';
    echo '<option data-icon="fas fa-microphone fa-fw" value="1"';
    if ($cfg['rankup_time_assess_mode'] == '1') {
        echo ' selected=selected';
    } echo '><span class="item-margin">',$lang['wishcolat'],'</span></option>';
    ?>
												</select>
											</div>
										</div>
