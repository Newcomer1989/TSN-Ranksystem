...
try {
    ...
    if (isset($_POST['update']) && isset($db_csrf[$_POST['csrf_token']])) {
        if (isset($_POST['stats_column_rank_switch'])) {
            $cfg['stats_column_rank_switch'] = 1;
        } else {
            $cfg['stats_column_rank_switch'] = 0;
        }
        if (isset($_POST['stats_column_client_name_switch'])) {
            $cfg['stats_column_client_name_switch'] = 1;
        } else {
            $cfg['stats_column_client_name_switch'] = 0;
        }
        if (isset($_POST['stats_column_unique_id_switch'])) {
            $cfg['stats_column_unique_id_switch'] = 1;
        } else {
            $cfg['stats_column_unique_id_switch'] = 0;
        }
        if (isset($_POST['stats_column_client_db_id_switch'])) {
            $cfg['stats_column_client_db_id_switch'] = 1;
        } else {
            $cfg['stats_column_client_db_id_switch'] = 0;
        }
        if (isset($_POST['stats_column_last_seen_switch'])) {
            $cfg['stats_column_last_seen_switch'] = 1;
        } else {
            $cfg['stats_column_last_seen_switch'] = 0;
        }
        if (isset($_POST['stats_column_nation_switch'])) {
            $cfg['stats_column_nation_switch'] = 1;
        } else {
            $cfg['stats_column_nation_switch'] = 0;
        }
        if (isset($_POST['stats_column_version_switch'])) {
            $cfg['stats_column_version_switch'] = 1;
        } else {
            $cfg['stats_column_version_switch'] = 0;
        }
        if (isset($_POST['stats_column_platform_switch'])) {
            $cfg['stats_column_platform_switch'] = 1;
        } else {
            $cfg['stats_column_platform_switch'] = 0;
        }
        if (isset($_POST['stats_column_online_time_switch'])) {
            $cfg['stats_column_online_time_switch'] = 1;
        } else {
            $cfg['stats_column_online_time_switch'] = 0;
        }
        if (isset($_POST['stats_column_idle_time_switch'])) {
            $cfg['stats_column_idle_time_switch'] = 1;
        } else {
            $cfg['stats_column_idle_time_switch'] = 0;
        }
        if (isset($_POST['stats_column_active_time_switch'])) {
            $cfg['stats_column_active_time_switch'] = 1;
        } else {
            $cfg['stats_column_active_time_switch'] = 0;
        }
        if (isset($_POST['stats_column_current_server_group_switch'])) {
            $cfg['stats_column_current_server_group_switch'] = 1;
        } else {
            $cfg['stats_column_current_server_group_switch'] = 0;
        }
        if (isset($_POST['stats_column_next_rankup_switch'])) {
            $cfg['stats_column_next_rankup_switch'] = 1;
        } else {
            $cfg['stats_column_next_rankup_switch'] = 0;
        }
        if (isset($_POST['stats_column_next_server_group_switch'])) {
            $cfg['stats_column_next_server_group_switch'] = 1;
        } else {
            $cfg['stats_column_next_server_group_switch'] = 0;
        }
        if (isset($_POST['stats_column_current_group_since_switch'])) {
            $cfg['stats_column_current_group_since_switch'] = 1;
        } else {
            $cfg['stats_column_current_group_since_switch'] = 0;
        }
        if (isset($_POST['stats_column_online_day_switch'])) {
            $cfg['stats_column_online_day_switch'] = 1;
        } else {
            $cfg['stats_column_online_day_switch'] = 0;
        }
        if (isset($_POST['stats_column_idle_day_switch'])) {
            $cfg['stats_column_idle_day_switch'] = 1;
        } else {
            $cfg['stats_column_idle_day_switch'] = 0;
        }
        if (isset($_POST['stats_column_active_day_switch'])) {
            $cfg['stats_column_active_day_switch'] = 1;
        } else {
            $cfg['stats_column_active_day_switch'] = 0;
        }
        if (isset($_POST['stats_column_online_week_switch'])) {
            $cfg['stats_column_online_week_switch'] = 1;
        } else {
            $cfg['stats_column_online_week_switch'] = 0;
        }
        if (isset($_POST['stats_column_idle_week_switch'])) {
            $cfg['stats_column_idle_week_switch'] = 1;
        } else {
            $cfg['stats_column_idle_week_switch'] = 0;
        }
        if (isset($_POST['stats_column_active_week_switch'])) {
            $cfg['stats_column_active_week_switch'] = 1;
        } else {
            $cfg['stats_column_active_week_switch'] = 0;
        }
        if (isset($_POST['stats_column_online_month_switch'])) {
            $cfg['stats_column_online_month_switch'] = 1;
        } else {
            $cfg['stats_column_online_month_switch'] = 0;
        }
        if (isset($_POST['stats_column_idle_month_switch'])) {
            $cfg['stats_column_idle_month_switch'] = 1;
        } else {
            $cfg['stats_column_idle_month_switch'] = 0;
        }
        if (isset($_POST['stats_column_active_month_switch'])) {
            $cfg['stats_column_active_month_switch'] = 1;
        } else {
            $cfg['stats_column_active_month_switch'] = 0;
        }
        if (isset($_POST['stats_show_excepted_clients_switch'])) {
            $cfg['stats_show_excepted_clients_switch'] = 1;
        } else {
            $cfg['stats_show_excepted_clients_switch'] = 0;
        }
        if (isset($_POST['stats_show_clients_in_highest_rank_switch'])) {
            $cfg['stats_show_clients_in_highest_rank_switch'] = 1;
        } else {
            $cfg['stats_show_clients_in_highest_rank_switch'] = 0;
        }
