...
function update_rs($mysqlcon, $lang, $cfg, $dbname, $norotate = null)
{
    ...
    $tables = ['addon_assign_groups', 'addons_config', 'admin_addtime', 'cfg_params', 'channel', 'csrf_token', 'groups', 'job_check', 'server_usage', 'stats_nations', 'stats_platforms', 'stats_server', 'stats_user', 'stats_versions', 'user', 'user_iphash', 'user_snapshot'];
